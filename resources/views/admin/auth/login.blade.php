                ...
                <div>
                    ...
                    <div class="relative">
                        <input 
                            ...
                            id="password" 
                            placeholder="••••••••"
                            class="w-full px-4 py-3 pr-11 bg-[#FFFBEB] border-[3px] border-[#1A1A2E] rounded-xl font-medium focus:outline-none focus:ring-2 focus:ring-[#4361EE] focus:bg-white transition-all text-[#1A1A2E]" 
                            required
                        >
                        <button 
                            type="button" 
                            onclick="if(window.togglePasswordVisibility){window.togglePasswordVisibility('password')}else{var el=document.getElementById('password');el.type=el.type==='password'?'text':'password'}"
                            tabindex="-1"
