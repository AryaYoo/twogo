...
@section('header')
    <div class="flex items-center gap-3">
        <a href="{{ route('trips.index') }}"
            class="w-10 h-10 bg-white border-[3px] border-[#1A1A2E] rounded-full flex items-center justify-center font-bold shadow-[2px_2px_0px_#1A1A2E] shrink-0 hover:translate-y-[-2px] transition-transform cursor-pointer"
            title="Kembali ke Trip Kamu">
            &larr;
        </a>
        <div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between relative">
            ...
            <div class="flex flex-col items-center z-10 gap-1" id="tracker-1">
                <div class="w-10 h-10 rounded-full border-[3px] border-[#1A1A2E] flex items-center justify-center font-heading font-extrabold text-sm transition-all duration-300 shadow-[2px_2px_0px_#1A1A2E] step-circle bg-[#FFE156] text-[#1A1A2E]"
                    id="circle-1">
                    <span class="step-num font-bold">1</span>
                    <span class="step-check hidden text-white font-extrabold">✓</span>
                </div>
                <span class="text-[10px] font-bold text-center text-[#1A1A2E] leading-tight" id="label-1">Nama
                    &<br>Destinasi</span>
            </div>

            {{-- Step 2 --}}
            <div class="flex flex-col items-center z-10 gap-1" id="tracker-2">
                <div class="w-10 h-10 rounded-full border-[3px] border-[#1A1A2E] flex items-center justify-center font-heading font-extrabold text-sm transition-all duration-300 shadow-[2px_2px_0px_#1A1A2E] step-circle bg-white text-[#1A1A2E] opacity-40"
                    id="circle-2">
                    <span class="step-num font-bold">2</span>
                    <span class="step-check hidden text-white font-extrabold">✓</span>
                </div>
                <span class="text-[10px] font-bold text-center text-[#1A1A2E] leading-tight opacity-40"
                    id="label-2">Tanggal<br>Perjalanan</span>
            </div>
            ...
            <div class="flex flex-col items-center z-10 gap-1" id="tracker-3">
                ...
                <span class="text-[10px] font-bold text-center text-[#1A1A2E] leading-tight opacity-40" id="label-3">Budget
                    &<br>Catatan</span>
            </div>
        </div>
        ...
        <div class="mt-3 h-[5px] bg-[#1A1A2E] bg-opacity-10 rounded-full border-[1.5px] border-[#1A1A2E] overflow-hidden">
            <div id="progress-bar" class="h-full rounded-full transition-all duration-500 ease-out bg-[#FFE156]"
                style="width: 33%"></div>
        </div>
    </div>
    ...
    <form action="{{ route('trips.store') }}" method="POST" id="trip-form">
        ...
        <div id="step-1" class="step-panel animate-fade-in-up">
            <div class="relative group mb-6">
                <div
                    class="absolute inset-0 bg-[#FFE156] border-[3px] border-[#1A1A2E] rounded-2xl rotate-1 transition-transform duration-300 group-hover:rotate-2">
                </div>
                <div
                    class="relative bg-[#FFFBEB] border-[3px] border-[#1A1A2E] rounded-2xl p-5 shadow-[5px_5px_0px_#1A1A2E]">
                    <div class="mb-5">
                        <div
                            class="w-12 h-12 bg-[#FFE156] border-[3px] border-[#1A1A2E] rounded-xl flex items-center justify-center text-2xl shadow-[2px_2px_0px_#1A1A2E] mb-3">
                            ✈️</div>
                        <h2 class="font-heading font-extrabold text-[#1A1A2E] text-xl">Mau kemana nih?</h2>
                        <p class="text-sm font-medium text-[#1A1A2E] opacity-60 mt-1">Kasih nama dan tujuan tripmu dulu ya!
                        </p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}"
                            placeholder="Liburan Akhir Pekan" class="nb-input" required>
                        @error('title')
                    ...
                    <div>
                        <label for="destination" class="nb-label">Destinasi Utama <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="destination" name="destination" value="{{ old('destination') }}"
                            placeholder="Bali, Indonesia" class="nb-input" required>
                        @error('destination')
                            <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div id="step-2" class="step-panel hidden">
            <div class="relative group mb-6">
                <div
                    class="absolute inset-0 bg-[#00D4AA] border-[3px] border-[#1A1A2E] rounded-2xl rotate-1 transition-transform duration-300 group-hover:rotate-2">
                </div>
                <div
                    class="relative bg-[#FFFBEB] border-[3px] border-[#1A1A2E] rounded-2xl p-5 shadow-[5px_5px_0px_#1A1A2E]">
                    <div class="mb-5">
                        <div
                            class="w-12 h-12 bg-[#00D4AA] border-[3px] border-[#1A1A2E] rounded-xl flex items-center justify-center text-2xl shadow-[2px_2px_0px_#1A1A2E] mb-3">
                            📅</div>
                        <h2 class="font-heading font-extrabold text-[#1A1A2E] text-xl">Kapan berangkat?</h2>
                        <p class="text-sm font-medium text-[#1A1A2E] opacity-60 mt-1">Pilih tanggal pergi dan pulang. Boleh
                            dikosongkan dulu!</p>
                    </div>
                    ...
                    <div
                        class="bg-[#FF6B9D] bg-opacity-10 border-[2px] border-[#FF6B9D] rounded-xl p-3 flex items-start gap-2">
        ...
        <div id="step-3" class="step-panel hidden">
            <div class="relative group mb-6">
                <div
                    class="absolute inset-0 bg-[#FF6B9D] border-[3px] border-[#1A1A2E] rounded-2xl rotate-1 transition-transform duration-300 group-hover:rotate-2">
                </div>
                <div
                    class="relative bg-[#FFFBEB] border-[3px] border-[#1A1A2E] rounded-2xl p-5 shadow-[5px_5px_0px_#1A1A2E]">
                    <div class="mb-5">
                        <div
                            class="w-12 h-12 bg-[#FF6B9D] border-[3px] border-[#1A1A2E] rounded-xl flex items-center justify-center text-2xl shadow-[2px_2px_0px_#1A1A2E] mb-3">
                            💰</div>
                        <h2 class="font-heading font-extrabold text-[#1A1A2E] text-xl">Berapa budgetnya?</h2>
                        <p class="text-sm font-medium text-[#1A1A2E] opacity-60 mt-1">Estimasi budget dan catatan. Semua
                            opsional kok!</p>
                    </div>

                    <div class="mb-4">
                        <label for="total_budget" class="nb-label">Total Budget <span
                                class="text-xs font-medium opacity-50">(Opsional)</span></label>
                        <div class="flex">
                            <div
                                class="bg-[#1A1A2E] text-[#FFE156] border-[3px] border-r-0 border-[#1A1A2E] rounded-l-xl px-3.5 flex items-center justify-center font-heading font-extrabold text-sm select-none shadow-[1px_1px_0px_#1A1A2E]">
                                Rp
                            </div>
                    ...
                    <div>
                        <label for="description" class="nb-label">Deskripsi / Catatan <span
                                class="text-xs font-medium opacity-50">(Opsional)</span></label>
                        <textarea id="description" name="description" placeholder="Trip santai aja, ga usah ngoyo... 😌"
            ...
            <div id="summary-box" class="bg-[#1A1A2E] border-[3px] border-[#1A1A2E] rounded-2xl p-4 mb-5 hidden">
                ...
                <div class="space-y-1">
                    <p class="text-white text-sm font-bold">🏷️ <span id="sum-title" class="font-medium opacity-80"></span>
                    </p>
                    <p class="text-white text-sm font-bold">📍 <span id="sum-dest" class="font-medium opacity-80"></span>
                    </p>
                    <p class="text-white text-sm font-bold" id="sum-date-row">📅 <span id="sum-date"
                            class="font-medium opacity-80"></span></p>
                </div>
            </div>
