...
<div class="grid grid-cols-2 gap-4">
    ...
    <a href="{{ route('search.cari') }}"
       class="nb-card bg-white flex flex-col items-center justify-center gap-3 py-7 px-3 text-center hover:bg-[#FFE156] hover:translate-y-[-3px] transition-all duration-200 group">
        <div class="w-14 h-14 bg-[#1A1A2E] rounded-xl flex items-center justify-center text-2xl border-[3px] border-[#1A1A2E] shadow-[3px_3px_0px_#FFE156] group-hover:shadow-[3px_3px_0px_#1A1A2E] transition-all">
            🔍
        </div>
        <div>
