...
<div class="relative max-w-sm mx-auto w-full mt-2 group">
    ...
    <div class="absolute inset-0 bg-[#00D4AA] border-[3px] border-[#1A1A2E] rounded-2xl rotate-2 transition-transform duration-300"></div>
    ...
    <div class="relative bg-[#FFFBEB] border-[3px] border-[#1A1A2E] shadow-[8px_8px_0px_#1A1A2E] rounded-2xl p-4 z-10">
        ...
        <h2 class="text-lg font-heading font-extrabold mb-3 text-center text-[#1A1A2E]">Buat Akun Baru 🚀</h2>
    
    <form action="{{ route('register') }}" method="POST" class="space-y-0">
        @csrf
        <div class="mb-3">
            <x-input 
                name="name" 
        ...
        <div class="mt-3">
            <x-button type="submit" variant="primary" class="w-full">Daftar Sekarang</x-button>
        </div>
    ...
    <p class="text-center mt-3 font-medium text-xs">
        Sudah punya akun? 
