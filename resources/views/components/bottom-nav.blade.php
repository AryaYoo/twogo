<nav class="bottom-nav">
    {{-- 5 items: Home/Trips, For You, Add Trip (center prominent), Budget, Profile --}}
    <a href="/trips" class="bottom-nav-item {{ request()->routeIs('trips.*') && !request()->routeIs('trips.create') && !request()->routeIs('expenses.*') ? 'active' : '' }}">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4"/></svg>
        <span>Trip</span>
    </a>
    <a href="/for-you" class="bottom-nav-item {{ request()->routeIs('for-you') ? 'active' : '' }}">
    ...
    <a href="/trips/create" class="bottom-nav-item bottom-nav-add">
        <div class="add-btn">
    ...
    <a href="/budget" class="bottom-nav-item {{ request()->routeIs('expenses.*') ? 'active' : '' }}">
